                         ...
                         xScale,yScale,colorScale)
{
    ...
    console.log(Opinions[2].Rating)
    target.selectAll("rect")
    .data(Opinions)
    .enter()
    .append("rect")
    .attr("x",function(Opinions){
    return xScale(Opinions.Rating)
})
...
//graph setup
var initGraph3 = function(Opinions)
{
    //size of screen
   ...
   .range(["GoldenRod","black","white",]);
    ...
    .attr("transform","translate(0,0)");
  drawRating(Opinions,target,graph,xScale,yScale,colorScale);
// drawRating2(Opinions,g1,graph,xScale,yScale,colorScale);
//    drawRating3(Opinions,g2,graph,xScale,yScale,colorScale);
//    drawRating4(Opinions,g3,graph,xScale,yScale,colorScale);
